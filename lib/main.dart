...
class _WebViewScreenState extends State<WebViewScreen> {
  ...
  final String _initialUrl = 'https://future-center.anmka.com/admin';
    ...
    if (_webViewController.platform is AndroidWebViewController) {
      (_webViewController.platform as AndroidWebViewController)
        ...
        ..setOnShowFileSelector(
          (params) => _handleAndroidFileSelection(params),
        );
    }
  ...
  Future<List<String>> _handleAndroidFileSelection(
    ...
    try {
      ...
      final ({FileType type, List<String>? allowedExtensions}) pickerConfig =
          _mapAcceptTypesToPickerConfig(params.acceptTypes);
  ...
  _mapAcceptTypesToPickerConfig(List<String> acceptTypes) {
